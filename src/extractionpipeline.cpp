 ...
 * Essentia: http://essentia.upf.edu. [1]
 * 
 ...
 * [2] Turchet, L., & Pauwels, J. (2021). Music emotion recognition: intention of composers-performers versus perception of musicians, non-musicians, and listening machines. IEEE/ACM Transactions on Audio, Speech, and Language Processing, 30, 305-316.
 * [3] Pons, J., & Serra, X. (2019). musicnn: Pre-trained convolutional neural networks for music audio tagging. arXiv preprint arXiv:1909.06654.
 * 
...
void extractFromFile(std::string audioFilename, std::vector<std::vector<Real>> &bandsVec)
{
    ...
    // This cuts the audio into frames of frameSize samples, with stepSize samples overlapping between consecutive frames
